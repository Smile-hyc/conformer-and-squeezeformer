...
# 训练集验证命令：python test_train_set.py --checkpoint checkpoints/best_model.ckpt --sample_count 1000
...
def main():
    parser = argparse.ArgumentParser(description="Conformer ASR 训练集测试脚本 (MindSpore, 忽略空格)")
